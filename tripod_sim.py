...
def g_dsp_adiabatic(t: float) -> float:
    """
    Adiabatic DSP coupling: g_eff = |dθ/dt|.
...
def H_tripod_t(t: float, args: dict) -> Qobj:
    """Effective DSP Hamiltonian with adiabatic coupling g = |dθ/dt|."""
...
def g_dsp_read(t: float) -> float:
    """DSP coupling during read: g_eff = |dθ_read/dt|."""
