...
def run_read_phase(psi_in: Qobj):
    ...
    Retrieval should emit photons rather than absorb them, so we reuse the
    time-reversed control envelope while flipping the signs of the σ± couplings
    to mimic time-reversed dynamics for this simple few-mode model.
    """
