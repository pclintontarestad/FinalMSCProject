...
def _hamiltonian_list(
    ...
    for projector, detuning in deltas.items():
...
def run_tripod_sequence(
    ...
    noise = noise or (PulseNoise.sample(control_params) if (control_params.sigma_eps or control_params.sigma_phi) else None)
